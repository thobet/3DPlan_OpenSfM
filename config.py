"""
This config script is taken from the OpenSfM software (https://github.com/mapillary/OpenSfM (Accessed: 22 January 2021))
"""
...
undistorted_image_format: tiff         # Format in which to save the undistorted images
